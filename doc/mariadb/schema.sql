...
-- Thu 04 Jan 2018 04:12:04 PM CET
...
CREATE TABLE IF NOT EXISTS `maestro`.`test_parameter` (
  ...
  `test_msg_properties_id` INT NULL,
...
CREATE TABLE IF NOT EXISTS `maestro`.`test_msg_property` (
  `test_parameter_id` INT NOT NULL,
  `test_msg_properties_name` VARCHAR(64) NOT NULL,
  `test_msg_properties_value` VARCHAR(128) NOT NULL,
  `test_msg_properties_description` VARCHAR(512) NULL,
  PRIMARY KEY (`test_parameter_id`, `test_msg_properties_name`),
