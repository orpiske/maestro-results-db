...
-- Sun 07 Jan 2018 12:17:50 PM CET
...
CREATE TABLE IF NOT EXISTS `maestro`.`test_fail_condition` (
  ...
  PRIMARY KEY (`test_id`, `test_fail_condition_name`, `test_fail_condition_resource_name`),
...
CREATE TABLE IF NOT EXISTS `maestro`.`test_msg_property` (
  ...
  PRIMARY KEY (`test_id`, `test_msg_property_resource_name`, `test_msg_property_name`),
