...
-- Fri 05 Jan 2018 11:21:54 AM CET
...
CREATE TABLE IF NOT EXISTS `maestro`.`env_results` (
  ...
  `test_rate_max` VARCHAR(45) NULL,
  `test_rate_error_count` VARCHAR(45) NULL,
  `test_rate_samples` VARCHAR(45) NULL,
  `test_rate_geometric_mean` VARCHAR(45) NULL,
  `test_rate_min` VARCHAR(45) NULL,
  `test_rate_standard_deviation` VARCHAR(45) NULL,
  `test_rate_skip_count` VARCHAR(45) NULL,
  `error` TINYINT NULL,
